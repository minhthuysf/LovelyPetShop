...
<html>
    <head>
        ...
        <title>Chó cưng - Lovely Petshop</title>
    </head>
            ...
            <form method="post" style="padding-top:20px;padding-bottom: 20px ">
                <div class="container" style="background-color: white;margin-bottom: 20px">
                    <div class="row" style=" ;margin-bottom: 10px;" >
                        ...
                        include 'connection.php';
                        $id = $_GET['cid'];
                        $query = "select * from category where CategoryId = $id and TypeId='1'";
                                ...
                                while ($row = $result1->fetch_array()) {
                                    ...
                                    <div class="col-md-3 col-sm-6 col-12">
                                        <div class="card card-product" style="margin-top: 8px;border:1px solid black;font-size: 20px;margin-bottom: 8px;height: 90%" >
                                            ...
                                            <div class="card-body">
                                                <a href="detailProductd.php?id=<?php echo $row['ProductId']; ?>" style="font-size:18px;text-decoration: none;"><?php echo $row['ProductName']; ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    if (isset($_SESSION['NameLogin'])) {
                                                        ...
                                                        <script>
                                                            function addcart() {
                                                                ...
                                                                window.location = "Productd.php?cid=<?php echo $id; ?>";
                                                    ...
                                                    ?>
                                                    <div class="col-md-4">
                                                        <a onclick="addcart()"  href="addCartcidpdog.php?id_product=<?php echo $idp; ?>&cidb=<?php echo $id;?>"   data-toggle="tooltip" data-placement="top"  title="Thêm vào giỏ hàng!" >
                        ...
                        <div class="col-md-4">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    ...
                                    <li class="page-item">
                                        <a class="page-link" href="Productd.php?cid=<?php echo $id; ?>&page=<?php
                                        if ($page == 1) {
                                            echo 1;
                                        } else {
                                            echo ($page - 1);
                                    ...
                                    for ($i = 1; $i <= $total_page; $i++) {
                                        ...
                                        ?>"><a class="page-link " href="Productd.php?cid=<?php echo $id; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                        <?php } ?>
                                    <li class="page-item">
                                        <a class="page-link" href="Productd.php?cid=<?php echo $id; ?>&page=<?php echo ($page + 1); ?>" aria-label="Next">
